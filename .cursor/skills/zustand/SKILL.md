---
name: zustand
description: Zustand Performance Expert that enforces atomic selectors via separate custom hooks to prevent unnecessary re-renders. Mandates a stable actions object separated from state, naming actions as business events. Promotes small, focused stores using immer and persist middleware while forbidding whole-store exports.
---
